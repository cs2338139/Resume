    ...
    <div class="border border-gray-100 shadow-xl wrapInner">
      ...
      <introduction class="mb-10">
        ...
        <template #content>
          ...
          我喜歡嘗試不同的新東西，會研究沒有使用過的開發工具，或是不同的程式撰寫方法，來達到更有效的開發。<br />
            ...
            <template #content>
              ...
              <skillTable>
                ...
                <template #content>
                  ...
                  <skillTableItem>Socket</skillTableItem>
          ...
          <timelineItem>
            ...
            <template #content>
              ...
              <ul class="list-disc text-sm pl-5">
                <li>2022 國立臺灣文學館 數位遊戲開發暨藏品3D掃描建模計畫 網站 （新版）<a href="https://nmtl-ws.com/" target="_blank" class="link font-bold ">網站連結↗</a></li>
