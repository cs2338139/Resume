...
<template>
  <div class="w-full flex flex-col justify-center items-center h-screen top-0 md:justify-start fixed">
    ...
    <div class="relative max-w-[1200px] flex justify-end w-full top-0 md:mt-5 sm:mt-2" @click="changeUrlQuery()">
      <button @click="changeUrlQuery()" class="w-16 h-16 sm:w-12 sm:h-12 hover:scale-110 origin-center duration-300 transition-transform">
